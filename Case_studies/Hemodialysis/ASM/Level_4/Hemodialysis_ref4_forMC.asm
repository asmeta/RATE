...
// RULE DEFINITIONS
	...
	//S-4
	//CTLSPEC ag((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and patientPhase = FILL_TUBING and err_patient_conn = false and error_bp = false and (blood_on_VRD = true or conn_infuse_set_volume = true)) implies ax(bp_status_der = STOP and patientPhase = CONN_VEN)) //true
	LTLSPEC g((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and patientPhase = FILL_TUBING and err_patient_conn = false and error_bp = false and (blood_on_VRD = true or conn_infuse_set_volume = true)) implies x(bp_status_der = STOP and patientPhase = CONN_VEN)) //true
	//S-5
	//CTLSPEC ef((art_connected_contr or ven_connected_contr) and (phaseTherapy = ENDING)) //1 vera
	//CTLSPEC ag((art_connected_contr or ven_connected_contr) and (phaseTherapy = INITIATION)) //2 falsa
	LTLSPEC g((art_connected_contr or ven_connected_contr) implies (phaseTherapy = INITIATION))
	LTLSPEC g((not art_connected_contr and x(art_connected_contr)) implies (phaseTherapy = INITIATION))
	LTLSPEC g((not ven_connected_contr and x(ven_connected_contr)) implies (phaseTherapy = INITIATION))
	//S-11
	//CTLSPEC ag(empty_dialyzer implies ag(bp_status_der = STOP)) //true
	LTLSPEC g(empty_dialyzer implies g(bp_status_der = STOP)) //true

	
	//tutte vere
	
	//R-1
	CTLSPEC ctlSpec_R1: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and arterialBolusPhase = RUNNING_SOLUTION and error_therapy = false and error_bp = false and error(ARTERIAL_BOLUS) = false and current_art_bolus_volume = 2) implies ax(error(ARTERIAL_BOLUS) = true and alarm(ARTERIAL_BOLUS) = true))
	
	//R-2
	CTLSPEC ctlSpec_R2: ag ((phaseTherapy = INITIATION and bp_status_der = START and error(BP_NO_FLOW) = false and (detected_blood_flow = false and passed120Sec = true)) implies ax(error(BP_NO_FLOW) = true and alarm(BP_NO_FLOW) = true))
	
	//R-3
	CTLSPEC ctlSpec_R3_a: ag ((phaseTherapy = INITIATION and bp_status_der = START and machine_status_der = MAIN_FLOW and error(BP_LESS_FLOW) = false and current_bp_flow_less_70 = true) implies ax(error(BP_LESS_FLOW) = true and alarm(BP_LESS_FLOW) = true))
	CTLSPEC ctlSpec_R3_b: ag ((phaseTherapy = INITIATION and bp_status_der = START and machine_status_der = MAIN_FLOW and error(BP_LESS_FLOW) = false and current_bp_flow_less_70 = true) implies ax(error(BP_LESS_FLOW) = true and alarm(BP_LESS_FLOW) = true))
	
	//R-4
	CTLSPEC ctlSpec_R4: ag ((phaseTherapy = INITIATION and bp_status_der = START and error(BP_ROTATION_DIR) = false and bp_rotates_back = true) implies ax (error(BP_ROTATION_DIR) = true and alarm(BP_ROTATION_DIR) = true))
	
	//R-5
	CTLSPEC ctlSpec_R5: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and ap_limits_set = true and vp_limits_set = true and error (INIT_VP_UP) = false and current_vp = 2) implies ax (error(INIT_VP_UP) = true and alarm(INIT_VP_UP) = true))
	
	//R-6
	CTLSPEC ctlSpec_R6: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and ap_limits_set = true and vp_limits_set = true and error (INIT_AP_UP) = false and current_ap = 2) implies ax (error(INIT_AP_UP) = true and alarm(INIT_AP_UP) = true))
	
	//R-7
	CTLSPEC ctlSpec_R7: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and ap_limits_set = true and vp_limits_set = true and error (INIT_VP_LOW) = false and current_vp = 0) implies ax (error(INIT_VP_LOW) = true and alarm(INIT_VP_LOW) = true))
	
	//R-8
	CTLSPEC ctlSpec_R8: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and ap_limits_set = true and vp_limits_set = true and error (INIT_AP_LOW) = false and current_ap = 0) implies ax (error(INIT_AP_LOW) = true and alarm(INIT_AP_LOW) = true))
	
	//R-9
	CTLSPEC ctlSpec_R9: ag ((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and err_patient_conn = false and error_bp = false and bp_status_der = START  and error(CONN_VP_UP) = false and current_vp = 2 and passed3Sec = true) implies ax (error(CONN_VP_UP) = true and alarm(CONN_VP_UP) = true))
	
	//R-10
	CTLSPEC ctlSpec_R10: ag ((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and err_patient_conn = false and error_bp = false and bp_status_der = START  and error(CONN_VP_LOW) = false and current_vp = 0 and passed3Sec = true) implies ax (error(CONN_VP_LOW) = true and alarm(CONN_VP_LOW) = true))
	
	//R-11
	CTLSPEC ctlSpec_R11: ag ((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and err_patient_conn = false and error_bp = false and bp_status_der = START  and error(CONN_AP_LOW) = false and current_ap = 0 and passed1Sec = true) implies ax (error(CONN_AP_LOW) = true and alarm(CONN_AP_LOW) = true))
	
	//R-12
	CTLSPEC ctlSpec_R12: ag ((phaseTherapy = INITIATION and modeEnding = REINFUSION and error_rein_press = false and error_bp = false and bp_status_der = START  and error(REIN_VP_UP) = false and current_vp = 2 and passed3Sec = true) implies ax (error(REIN_VP_UP) = true and alarm(REIN_VP_UP) = true))
	...
	//R-20
	CTLSPEC ctlSpec_R20: ag ((phaseTherapy = INITIATION and error(TEMP_HIGH) = false and current_temp = 2) implies ax(error(TEMP_HIGH) = true and alarm(TEMP_HIGH) = true))
	
	//R-21
	CTLSPEC ctlSpec_R21: ag ((phaseTherapy = INITIATION and error(TEMP_LOW) = false and current_temp = 0) implies ax(error(TEMP_LOW) = true and alarm(TEMP_LOW) = true))
	
	//R-22
	CTLSPEC ctlSpec_R22: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and heparin_running = true and error(HEPARIN_DIR) = false and reverse_dir_heparin = true) implies ax(error(HEPARIN_DIR) = true and alarm(HEPARIN_DIR) = true))
	
	//R-23_30
	CTLSPEC ctlSpec_R23_30: ag ((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and err_patient_conn = false and error_bp = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 4)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-23_31
	CTLSPEC ctlSpec_R23_31: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 4)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-23_32
	CTLSPEC ctlSpec_R23_32: ag ((phaseTherapy = ENDING and modeEnding = REINFUSION and error_rein_press = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 4)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-24_30
	CTLSPEC ctlSpec_R24_30: ag ((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and err_patient_conn = false and error_bp = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 1 and current_air_vol > 0)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-24_31
	CTLSPEC ctlSpec_R24_31: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 1 and current_air_vol > 0)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-24_32
	CTLSPEC ctlSpec_R24_32: ag ((phaseTherapy = ENDING and modeEnding = REINFUSION and error_rein_press = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 1 and current_air_vol > 0)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-25_30
	CTLSPEC ctlSpec_R25_30: ag ((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and err_patient_conn = false and error_bp = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 2 and current_air_vol > 1)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-25_31
	CTLSPEC ctlSpec_R25_31: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 2 and current_air_vol > 1)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-25_32
	CTLSPEC ctlSpec_R25_32: ag ((phaseTherapy = ENDING and modeEnding = REINFUSION and error_rein_press = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 2 and current_air_vol > 1)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-26_30
	CTLSPEC ctlSpec_R26_30: ag ((phaseTherapy = INITIATION and modeInitiation = CONNECT_PATIENT and err_patient_conn = false and error_bp = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 3 and current_air_vol > 2)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-26_31
	CTLSPEC ctlSpec_R26_31: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 3 and current_air_vol > 2)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-26_32
	CTLSPEC ctlSpec_R26_32: ag ((phaseTherapy = ENDING and modeEnding = REINFUSION and error_rein_press = false and bp_status_der = START and error(SAD_ERR) = false and (passed1Msec = true and currentSAD = 3 and current_air_vol > 2)) implies ax(error(SAD_ERR) = true and alarm(SAD_ERR) = true))
	
	//R-33
	CTLSPEC ctlSpec_R33: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bicarbonate_status_der = true and error(UF_RATE) = false and uf_rate_passed_max_uf_rate = true) implies ax(error(UF_RATE) = true and alarm(UF_RATE) = true))
	
	//R-34
	CTLSPEC ctlSpec_R34: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bicarbonate_status_der = true and error(UF_DIR) = false and uf_dir_backwards = true) implies ax(error(UF_DIR) = true and alarm(UF_DIR) = true))
	
	//R-35
	CTLSPEC ctlSpec_R35: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bicarbonate_status_der = true and alarm(UF_VOLUME_ERR) = false and uf_volume_passed_max_uf_volume = true) implies ax(alarm(UF_VOLUME_ERR) = true))
	
	//R-36
	CTLSPEC ctlSpec_R36: ag ((phaseTherapy = INITIATION and modeInitiation = THERAPY_RUNNING and therapyPhase = THERAPY_EXEC and error_therapy = false and bicarbonate_status_der = true and alarm(UF_BYPASS) = false and machine_status_der = BYPASS) implies ax(alarm(UF_BYPASS) = true))

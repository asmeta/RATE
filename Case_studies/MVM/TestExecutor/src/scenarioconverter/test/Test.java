...
public class Test {
	...
	public static List<Configuration> filesToProcess = new ArrayList<Configuration>() {
		...
		{			
			...
			add(new Configuration("0", "config/config0.json", CriteriaEnum.COMBINATORIAL_ALL));
			add(new Configuration("1", "config/config1.json", CriteriaEnum.COMBINATORIAL_ALL));
			add(new Configuration("2", "config/config2.json", CriteriaEnum.COMBINATORIAL_ALL));
			add(new Configuration("3", "config/config3.json", CriteriaEnum.COMBINATORIAL_ALL));
			add(new Configuration("NR", "config/config3.json", CriteriaEnum.COMBINATORIAL_ALL));
			...
			add(new Configuration("0", "config/config0.json", CriteriaEnum.THREEWISE));
			add(new Configuration("1", "config/config1.json", CriteriaEnum.THREEWISE));
			add(new Configuration("2", "config/config2.json", CriteriaEnum.THREEWISE));
			add(new Configuration("3", "config/config3.json", CriteriaEnum.THREEWISE));
			add(new Configuration("NR", "config/config3.json", CriteriaEnum.THREEWISE));
			
			add(new Configuration("0", "config/config0.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_ALL, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));
			add(new Configuration("1", "config/config1.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_ALL, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));
			add(new Configuration("2", "config/config2.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_ALL, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));
			add(new Configuration("3", "config/config3.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_ALL, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));
			add(new Configuration("NR", "config/config3.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_ALL, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));
			add(new Configuration("00", "config/config3.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_MON, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));
			add(new Configuration("01", "config/config3.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_MON, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));
			add(new Configuration("02", "config/config3.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_MON, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE));

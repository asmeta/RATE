...
public class Test {
	...
	public static List<Configuration> filesToProcess = new ArrayList<Configuration>() {
		...
		{			
			...
			add(new Configuration("01", "config/config3.json", /*CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_MON, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE,*/ CriteriaEnum.THREEWISE_MON));
			add(new Configuration("02", "config/config3.json", CriteriaEnum.BASIC_RULE, CriteriaEnum.COMBINATORIAL_MON, CriteriaEnum.COMPLETE_RULE, CriteriaEnum.MCDC, CriteriaEnum.RULE_GUARD, CriteriaEnum.RULE_UPDATE, CriteriaEnum.THREEWISE_MON));
